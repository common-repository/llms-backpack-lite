...
class CourseOutlinePerID extends Config implements RequiredFunctions {
	/**
	 * Class constructor
	 */
	...
	public static function run_frontend_hooks() {
		if ( true === self::dependants_exist() ) {
			...
			if(in_array('llms_bkpk\CourseOutlinePerID',$llms_bkpk_active_classes_opt)){
...
//		$option_value = $mydata[0]['value']; 
		...
		public static function get_details() {
			$class_title       = esc_html__( 'Other Course Sections Menu', 'lifterlms-bkpk' );
			$customizer_link   = '#';
			$class_description = esc_html__( 'Show the Sections menu of another course.', 'lifterlms-bkpk' );
	...
	public static function get_class_settings( $class_title ) {
		...
		$options = array(
			array(
				'type'        => 'html',
				'inner_html'  => '<center><strong><h2><a href="https://learning-templates.com/product/lifterlms-backpack/" target="_blank" class="go-pro">Subscribe to BackPack to enable this feature</a></h2></strong></center><br/><strong><h2>Show a menu with the section names of another course.</h2></strong>Once activated, use this <code>[llms_resource_menu id="#####"]</code> shortcode to display that other courses sections in a menu.<br/>When the student clicks on a menu item, it will take them to the first lesson in that section of the other course.</b>',
			),
			array(
				'type'        => 'text',
				'label'       => esc_html__( 'Font-Awesome Completed Icon', 'llms-bkpk' ),
				'placeholder'       => esc_html__( '', 'llms-bkpk' ),
				'option_name' => 'llms-bkpk-other-course-completed-icon',
			),
			array(
				'type'        => 'text',
				'label'       => esc_html__( 'Font-Awesome Incomplete Icon', 'llms-bkpk' ),
				'placeholder'       => esc_html__( '', 'llms-bkpk' ),
				'option_name' => 'llms-bkpk-other-course-incomplete-icon',
			),
		);
		// Build html
