...
class OtherCourseOutlineID extends Config implements RequiredFunctions {
	...
	public static function run_frontend_hooks() {
		if ( true === self::dependants_exist() ) {
			...
			if(in_array('llms_bkpk\OtherCourseOutlineID',$llms_bkpk_active_classes_opt)){
...
/*		$url = '';
		...
		$class_title       = esc_html__( 'Other Course Outline', 'lifterlms-bkpk' );
		$customizer_link           = '#';
		$class_description = esc_html__( 'Show the Sections of another course as a menu.', 'lifterlms-bkpk' );
	...
	public static function get_class_settings( $class_title ) {
		...
		$options = array(
			array(
				'type'        => 'html',
				'inner_html'  => '<center><strong><h2><a href="https://learning-templates.com/product/lifterlms-backpack/" target="_blank" class="go-pro">Subscribe to BackPack to enable this feature</a></h2></strong></center><br/><strong><h2>Show a menu with the section names of any course.</h2></strong>Once activated, use this <code>[llms_course_menu id="#####"]</code> shortcode to display the other courses sections in a menu.<br/>When the student clicks on a menu item, it will take them to the first lesson in that section of the other course.</b>',
			),
			array(
				'type'        => 'text',
