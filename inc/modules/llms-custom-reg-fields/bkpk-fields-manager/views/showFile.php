<?php
/**
 * Not in use since 1.1.7
 * Need to check more when removing this file.
 */
global $bkpkFM;
...
elseif (! empty($filepath)) :
    $uploads = $bkpkFM->determinFileDir($filepath);
...
if ((! empty($avatar) || ! empty($filepath)) && empty($readonly))
    $html .= "<p><a href='#' onclick='umRemoveFile(this)' name='$field_name'>" . __('Remove', $bkpkFM->name) . "</a><p>";
